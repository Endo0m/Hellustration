...
public abstract class EnemyBase : MonoBehaviour
{
    ...
    [SerializeField] protected float minTimeUntilAggressive = 180f; // ћинимальное врем€ (3 минуты)
    [SerializeField] protected float maxTimeUntilAggressive = 300f; // ћаксимальное врем€ (5 минут)
